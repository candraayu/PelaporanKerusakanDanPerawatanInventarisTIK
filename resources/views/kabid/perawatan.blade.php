...
@section('title', 'Monitoring Perawatan')

@section('content')
<div class="row mb-4">
    <div class="col-12 d-flex justify-content-between align-items-center">
        <h4 class="fw-bold py-3 mb-0">Monitoring Perawatan</h4>

        {{-- SEARCH KECAMATAN --}}
        <form action="{{ route('kabid.perawatan.index') }}" method="GET" class="d-flex gap-2">
            <div class="input-group">
                <input type="text" name="search" class="form-control"
                    placeholder="Cari perawatan/kecamatan..."
                    value="{{ request('search') }}">
                <button class="btn btn-primary" type="submit">
                    <i class="bx bx-search"></i>
                </button>
                @if(request('search'))
                    <a href="{{ route('kabid.perawatan.index') }}" class="btn btn-outline-secondary">
                        <i class="bx bx-x"></i>
                    </a>
                @endif
            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        <label class="form-label text-muted">Kode Inventaris</label>
